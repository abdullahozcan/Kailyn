...
class ComposerAutoloaderInitf4eebb2db673a5e2e7c1e964b99dd4df
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitf4eebb2db673a5e2e7c1e964b99dd4df::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequiref4eebb2db673a5e2e7c1e964b99dd4df($fileIdentifier, $file);
        }
...
function composerRequiref4eebb2db673a5e2e7c1e964b99dd4df($fileIdentifier, $file)
{
